...
class UserRepositoryTest {
    ...
    private void clearUsersTable() {
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            // Затем удаляем все записи из composite_functions, если таблица существует
            try {
                stmt.executeUpdate("DELETE FROM composite_functions");
            } catch (Exception e) {
                // Игнорируем ошибки, если таблица не существует или пуста
            }
            // Теперь можно безопасно удалить всех пользователей
            try {
